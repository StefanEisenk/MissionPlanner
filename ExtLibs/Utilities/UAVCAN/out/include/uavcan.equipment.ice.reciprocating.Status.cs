...
public class uavcan_equipment_ice_reciprocating_Status: IUAVCANSerialize {
    ...
    public Half spark_dwell_time_ms = new Half();



    public Half atmospheric_pressure_kpa = new Half();



    public Half intake_manifold_pressure_kpa = new Half();



    public Half intake_manifold_temperature = new Half();



    public Half coolant_temperature = new Half();



    public Half oil_pressure = new Half();



    public Half oil_temperature = new Half();



    public Half fuel_pressure = new Half();
